      ...
      <div class="mb-6">
        ...
        <div class="flex items-center gap-2">
          <input
            ...
            readonly
            class="flex-1 bg-gray-50 dark:bg-gray-700 border-2 focus:outline-none border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg px-4 py-3 font-mono text-lg"
          />
          <button
            on:click={copyToClipboard}
            class="px-6 py-3 bg-[#FF6B35] hover:bg-[#004E89] text-white font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg whitespace-nowrap"
          >
            {#if copied}
              ✓ Copied!
            {:else}
      ...
      <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
        ...
        <div class="flex flex-wrap gap-3">
          <button
            ...
            class="flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors duration-200"
          >
          ...
          <button
            ...
            class="flex items-center gap-2 px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200"
          >
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
